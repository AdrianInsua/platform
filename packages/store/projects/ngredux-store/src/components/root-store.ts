...
import { Comparator, PathSelector, resolveToFunctionSelector, Selector } from './selectors';
...
export class RootStore<RootState> extends NgRedux<RootState> {
    ...
    ): ObservableStore<SubState> => new SubStore<SubState>(this, basePath, localReducer);
